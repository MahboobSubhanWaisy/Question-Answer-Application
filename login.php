...
<section class="login-area pt-80px pb-80px position-relative">
    ...
    <div class="container">
        <form action="login_code.php" method="post" class="card card-item login-form">
                ...
                <div class="col-lg-5 mx-auto">
                    <div class="form-action-wrapper py-5">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" class="form-control form--control" autocomplete="off" id="email" placeholder="Email address">
                            <h6 id="email-error" class="error_message">
                                Enter Your Email.
                            </h6>
                        </div>
                        <div class="form-group">
                            ...
                            <h6 id="password-error" class="error_message">
                                Enter Your Password.
                            </h6>
                        </div>
                        <?php
                            if (@$_GET['login'] == true) {
                        ?>
                            <div class="alert-danger text-danger text-center py-1 mb-4"><?php echo $_GET['login'] ?></div>   
                        <?php } ?>
                        <div class="form-group">
                            <button id="login-submit" name="login" class="btn theme-btn w-100" type="submit">Login <i class="la la-arrow-right icon ml-1"></i></button>
                        </div>
                    </div>
                </div>
            </div>
        </form>
        <p class="text-black text-center fs-15">Don't have an account? <a href="register.php" class="text-color hover-underline">Sign up</a></p>
    </div><!-- end container -->
</section>
