...
<section class="client-logo-area section--padding bg-radial-gradient-gray">
    <div class="container">
        <div class="client-logo-box">
            <h3 class="fs-21 text-center text-gray">Thousands of organizations around the globe use Q&A for Teams</h3>
...
<section class="get-started-area section--padding pattern-bg" id="for-developers">
    <div class="container">
        <div class="text-center">
            ...
            <p class="section-desc w-50 mx-auto">Q&A is an open community for anyone that codes. We help you get answers
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <a href="questions.php" class="btn theme-btn">Browse questions <i class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text pb-4">This is just a simple text made for this unique and awesome template, you can easily edit it as you want.</p>
                        <a href="questions.php" class="btn theme-btn bg-3">Try for free <i class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y text-center">
                    <div class="card-body">
                        ...
                        <p class="card-text pb-4">This is just a simple text made for this unique and awesome template, you can easily edit it as you want.</p>
                        <a href="jobs.php" class="btn theme-btn">Find a job <i class="la la-arrow-right icon ml-1"></i></a>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
            ...
            <div class="col-lg-5">
                <div class="info-box text-center">
                    ...
                    <div class="info-body">
                        ...
                        <a href="talent.html" class="btn theme-btn">Q&A Talent <i class="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
            </div><!-- end col-lg-5 -->
            <div class="col-lg-2">
            ...
            <div class="col-lg-5">
                <div class="info-box text-center">
                    ...
                    <div class="info-body">
                        ...
                        <p class="pb-4">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that</p>
                        <a href="advertising.html" class="btn theme-btn">Q&A Advertising <i class="la la-arrow-right icon ml-1"></i></a>
                    </div>
                </div>
            </div><!-- end col-lg-5 -->
        </div><!-- end row -->
...
<section class="get-started-area section--padding">
    <div class="container">
        <div class="text-center">
            <h2 class="section-title">Learn and grow with Q&A</h2>
        </div>
        <div class="row pt-50px">
            <div class="col-lg-3 responsive-column-half">
