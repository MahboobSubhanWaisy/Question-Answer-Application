...
<?php
	$id=$_GET['id'];
	$sql = "SELECT users.id, client_info.* FROM `users` INNER JOIN client_info ON client_info.cl_id = users.record_id WHERE users.id = '$id' limit 0,1";
	$query = mysqli_query($conn, $sql);
	$data = mysqli_fetch_array($query);

	$cl_id = $data['cl_id'];
	$result = mysqli_query($conn,"SELECT * FROM questions WHERE client_id = '$cl_id'");
			...
			<div class="row">
						...
						<div class="media media-card align-items-center shadow-none p-0 mb-0 rounded-0 bg-transparent">
							<div class="media-img media--img">
								<?php
									if($data['photo'] != ''){
								?>
									<img src="images/<?php echo $data['photo']; ?>" alt="company logo">
								<?php }else{ ?>
									<img src="images/user_default.jpg" alt="company logo">
								<?php } ?>
							</div>
							<div class="media-body">
								<h5> <?php echo $data['fall_name']?></h5>
				...
				<div class="col-lg-4">
					<div class="hero-btn-box text-right py-3">
						<a href="edit_profile.php?id=<?php echo $id;?>" class="btn theme-btn theme-btn-outline theme-btn-outline-gray"><i class="la la-gear mr-1"></i> Edit Profile</a>
					</div>
				</div><!-- end col-lg-4 -->
				<div class="col-lg-12">
									...
									<div class="row">
										...
										<div class="col-lg-4 responsive-column-half">
											<div class="media media-card align-items-center shadow-none border border-gray p-3">
												...
												<div class="media-body">
													<h5 class="fw-medium"><?php echo $row;?></h5>
